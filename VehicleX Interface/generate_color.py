...
import sys
import argparse
from utils import ancestral_sampler_fix_sigma, get_random_color, get_color_by_id
import time
...
parser.add_argument("--car_id", type=int,
                    help="Vehicle model id, integer in range of [1, 178]")
...
if (opt.car_id is not None and opt.car_id not in range(1, 179)) or \
